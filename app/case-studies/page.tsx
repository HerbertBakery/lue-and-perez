...
const cases = [
  {
    ...
    summary: 'Reduced freight/unit by 18%, synchronized shelf-life windows.',
  },
  {
    slug: 'private-label-pepper-sauce',
    title: 'Private Label Pepper Sauce — Canada',
    summary: 'Standardized recipe, bilingual labels, CFIA import compliance. Ongoing supply chain to Canada.',
  },
  {
    slug: 'frozen-bakery-middle-east',
    title: 'Frozen Bakery SKUs — Middle East',
    summary: 'Cold chain with 2-stop routing, shipped within 72h of production.',
  },
]
